...
// Datos de prueba
const miembros = ref([
  { IDMIEMBRO: 111, NOMBRE: 'HAROLD BULA HERAZO', CARGO: 'DECANO' },
  { IDMIEMBRO: 222, NOMBRE: 'PIERRE AUGUSTO PEÑA SALGADO', CARGO: 'JEFE DPTO, ING. DE SISTEMA' },
  { IDMIEMBRO: 333, NOMBRE: 'DEMOSTENES DURANGO ALVAREZ', CARGO: 'JEFE DPTO, ING. MECANICA' },
  { IDMIEMBRO: 444, NOMBRE: 'DEIVIS LUJAN RHENALS', CARGO: 'JEFE DPTO, ING. DE ALIMENTOS' },
  { IDMIEMBRO: 555, NOMBRE: 'LUIS MERCADO HOYOS', CARGO: 'JEFE DPTO, ING. INDUSTRIAL' },
  { IDMIEMBRO: 666, NOMBRE: 'DOTIS MEJIA AVILA', CARGO: 'JEFE DPTO, ING. AMBIENTAL' },
  {
    IDMIEMBRO: 777,
    NOMBRE: 'VLADIMIR GONZALEZ BALLESTEROS',
    CARGO: 'REPRESENTANTE DE LOS ESTUDIANTES'
  },
  { IDMIEMBRO: 888, NOMBRE: 'ALVARO GOMEZ OSORIO', CARGO: 'REPRESENTANTE DE LOS PROFESORES' }
])
